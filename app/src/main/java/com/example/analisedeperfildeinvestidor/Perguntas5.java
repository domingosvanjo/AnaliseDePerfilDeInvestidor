...
public class Perguntas5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opt1 = (RadioButton) findViewById(R.id.opt21);
        opt2 = (RadioButton) findViewById(R.id.opt22);
        opt3 = (RadioButton) findViewById(R.id.opt23);
        opt4 = (RadioButton) findViewById(R.id.opt24);
        opt5 = (RadioButton) findViewById(R.id.opt25);
    ...
    void proximo(){
        ...
        Intent proximaTela = new Intent(Perguntas5.this, Perguntas6.class);
