...
public class Perguntas7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opt1 = (RadioButton) findViewById(R.id.opt31);
        opt2 = (RadioButton) findViewById(R.id.opt32);
        opt3 = (RadioButton) findViewById(R.id.opt33);
        opt4 = (RadioButton) findViewById(R.id.opt34);
        opt5 = (RadioButton) findViewById(R.id.opt35);
    ...
    void proximo(){
        ...
        Intent proximaTela = new Intent(Perguntas7.this, MainActivity.class);
